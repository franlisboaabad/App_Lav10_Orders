            ...
            <div class="card">
                <div class="card-body">
                                    ...
                                    <tbody>
                                        @forelse($specialist->serviceOrders as $order)
                                            <tr>
                                                ...
                                                <td>{{ $order->deviceModel->brand->name }} - {{ $order->deviceModel->name }}</td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="{{ route('service-orders.show', $order) }}" class="btn btn-info btn-sm">
                                                        <i class="ti-eye"></i>
                                                    </a>
                                                </td>
                                            </tr>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="text-end">
                                <a href="{{ route('admin.specialists.index') }}" class="btn btn-secondary me-1">Volver</a>
                                <a href="{{ route('admin.specialists.edit', $specialist) }}" class="btn btn-primary">Editar Especialista</a>
                            </div>
                        </div>
                    </div>
                </div>
