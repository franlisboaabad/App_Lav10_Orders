...
<div class="content-wrapper">
    <div class="row">
        <div class="col-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Nuevo Especialista</h4>
                    ...
                    <form action="{{ route('admin.specialists.store') }}" method="POST" class="forms-sample">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('specialties') is-invalid @enderror"
                                ...
                                <option value="Reparación de Consolas">Reparación de Consolas</option>
