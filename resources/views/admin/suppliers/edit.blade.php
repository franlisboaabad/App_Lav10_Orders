            ...
            <div class="card-body py-0 px-0 px-sm-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-3 col-sm-2 col-xl-2 ps-0 text-center">
                        <span>
                            <h6 class="mb-1 mb-sm-0">Editar Proveedor</h6>
                            <p class="mb-0 font-weight-normal d-none d-sm-block">Modificar información del proveedor</p>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('document_type') is-invalid @enderror"
                                    ...
                                    <option value="DNI" {{ old('document_type', $supplier->document_type) == 'DNI' ? 'selected' : '' }}>DNI</option>
                                    <option value="RUC" {{ old('document_type', $supplier->document_type) == 'RUC' ? 'selected' : '' }}>RUC</option>
                                    <option value="CE" {{ old('document_type', $supplier->document_type) == 'CE' ? 'selected' : '' }}>CE</option>
                                </select>
                                @error('document_type')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('document_number') is-invalid @enderror"
                                       id="document_number" name="document_number" value="{{ old('document_number', $supplier->document_number) }}" required>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('suppliers.index') }}" class="btn btn-light">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
