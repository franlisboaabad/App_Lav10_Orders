            ...
            <div class="card-body py-0 px-0 px-sm-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-3 col-sm-2 col-xl-2 ps-0 text-center">
                        <span>
                            <h6 class="mb-1 mb-sm-0">Editar Marca</h6>
                            <p class="mb-0 font-weight-normal d-none d-sm-block">Modificar marca existente</p>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('brands.update', $brand) }}">
                    @csrf
                    @method('PUT')
